-- APPLY_IN_DASHBOARD.sql - both migrations combined, idempotent, run once.
-- Supabase Dashboard -> SQL Editor -> paste everything -> Run.

-- 0001_waitlist_signups.sql â€” M1 email capture
...
-- 0002_core_schema.sql â€” M2 (billing) + M3 (issues/pipeline) + M4 (ops) tables
...
-- Small metadata only (titles/urls/dates) â€” never full source content.
